...
interface Props {
  ...
  phoneNumber?: string; // e.g. "+27 82 ••• ••• 85"
}

const OTPVerificationPage: React.FC<Props> = ({ phoneNumber = '+27 82 ••• ••• 85' }) => {
  ...
  const handleVerify = () => {
    ...
    // navigation.navigate('PersonalDetails', { code: fullCode });
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Text style={styles.btnPrimaryText}>Verify & Sign Up</Text>
            </TouchableOpacity>
