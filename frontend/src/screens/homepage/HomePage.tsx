...
// ── Bottom Nav ────────────────────────────────────────────────────────────────
const BottomNav: React.FC<{ onHelpMe: () => void; onChat: () => void }> = ({
  onHelpMe,
  onChat,
}) => (
  <View style={nav.wrap}>
...
const HomePage: React.FC = () => {
  ...
  async function getNotifications() {
    ...
    const filtered = data.filter((item) => item.read === false);
      ...
      >
        ...
        >
          ...
          <View style={styles.topBar}>
            ...
            >
              <View style={notifications.length > 0 ? styles.bellBadge : null}>
